  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // gray/green/orange/pink come from the Strand preset — masterbrand palette
        // (mb-green, mb-orange, mb-peach, mb-pink) and Strand gray-50…gray-700.
        // Do not redefine those ramps here or the preset will be overridden.
      },
      borderRadius: {
        lg: "var(--radius)",
