        ...
        <Card className="p-6 h-full">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <Text as="p" className="text-xl font-bold text-purple-600">{competitiveContext.premiumContent}%</Text>
                <div className="w-24 bg-muted rounded-full h-2 mt-1">
                  <div className="bg-purple-500 h-2 rounded-full" style={{ width: `${competitiveContext.premiumContent}%` }}></div>
                </div>
              </div>
            </div>
          </div>
